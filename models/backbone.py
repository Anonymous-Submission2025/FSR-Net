...
class Conv2d_BN(torch.nn.Sequential):
    def __init__(self, a, b, ks=1, stride=1, pad=0, dilation=1,
        ...
        self.add_module('c', torch.nn.Conv2d(
            a, b, ks, stride, pad, dilation, groups, bias=False))  # 不使用偏置
...
if __name__ == '__main__':
    ...
    decoder4 = decoder4(256, 128)
    decoder3 = decoder_1_2_3(128, 64)
    decoder2 = decoder_1_2_3(64, 32)
    decoder1 = decoder_1_2_3(32, 16)
...
#     encoder1 = enconder1(3, 128)
#     encoder2 = enconder2_3(128, 256)
#     encoder3 = enconder2_3(256, 384)
#     encoder4 = enconder4(384, 512)
